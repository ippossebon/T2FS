...
Função: Criar um novo arquivo.
	O nome desse novo arquivo é aquele informado pelo par�metro "filename".
...
Sa�da:	Se a operação foi realizada com sucesso, a fun��o retorna o handle do arquivo (n�mero positivo)
	Em caso de erro, deve ser retornado um valor negativo
-----------------------------------------------------------------------------*/
...
Função:	Criar um novo diretório.
	...
	A criação de um novo subdiretorio deve ser acompanhada pela criação, automática, das entradas "." e ".."
